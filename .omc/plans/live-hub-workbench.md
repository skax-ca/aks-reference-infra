...
argocd·az CLI)을 만든다.
**범위 밖**: GUI 데스크톱 workbench(③안, `.omc/notepad.md` 8차 세션 기록의 경로 비교 참고),
`live/dev/aks`용 workbench(dev 인스턴스 자체가 아직 없음), Bastion.
...
8. 세션 종료 시 `.omc/notepad.md`·`project-memory.json` 갱신(notepad-sync 절차)
